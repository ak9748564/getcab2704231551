...
<body>
    ...
    <div id="section1a" style="height:380px;">
        <div>
            <div style="width:36%;"><a href="">HOME&nbsp;&nbsp;</a>&nbsp;&nbsp;/&nbsp;&nbsp;ALL POSTS&nbsp;&nbsp;/&nbsp;&nbsp;TAXI BENEFITS THAT SAVE TIME AND MONEY</div>
            <h1 style="text-align: center;">Taxi Benefits that Save Time and Money</h1>
        </div>
    </div>
    <div id="section2on">
        <div>
            <div id="containeron">
                <div id="cont1on">
                    <div class="containeron">
                        <a href="">Taxi Benefits that Save Time and Money</a>
                        <img src="../images/image-1-370x300.jpg" alt="" style="width:100%;margin-top:50px;">
                        ...
                        <p> ut perspiciatis, unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam eaque ipsa, quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt, explicabo. nemo enim ipsam voluptatem, quia voluptas sit, aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos, qui ratione voluptatem sequi nesciunt, neque porro quisquam est, qui dolorem ipsum, quia dolor sit, amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt, ut labore et dolore magnam aliquam quaerat voluptatem. ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur?</p>
                    </div>
                    ...
                    <div style="display: flex;justify-content:space-between;align-items:center;">
                        <div>
                            <div style="display: flex;align-items:center;" id="categories">
                                <h1>Categories:&nbsp;</h1><a>city life</a>
                            </div>
                    ...
                    <div>
                        <div class="comments">
                            <div style="width: 120px;">
                                <img src="images/user_profile_comment.png" alt="" style="width: 100%;">
                            </div>
                            <div style="padding:0px 20px;">
                                <h1>by Arman Khan Posted 4 July, 2022 8:25 am</h1>
                                <h2>Comment2</h2>
                                <h3>REPLY</h3>
                            </div>
                        </div>
                    ...
                    <div>
                        <form>
                            ...
                            <div class="mb-3 shadow-none brd" style="margin: 10px;border:2px solid #fff;border-radius:0px;">
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Your Comment" style="box-shadow: none;border-radius:0px;" name="comment"></textarea>
                            </div>
