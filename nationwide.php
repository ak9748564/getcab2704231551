...
<body>
    <div id="section1a" style="height:380px;">
        <div>
            <div style="max-width:485px;"><a href="">HOME&nbsp;&nbsp;</a>&nbsp;&nbsp;/&nbsp;&nbsp;ALL SERVICES&nbsp;&nbsp;/&nbsp;&nbsp;OUR BENFITS&nbsp;&nbsp;/&nbsp;&nbsp;NATIONWIDE</div>
            <h1 style="text-align: center;">Nationwide</h1>
        </div>
    </div>
    <div id="section2on">
        <div>
            <div id="containeron">
                <div id="cont1on">
                    <div class="containeron">
                        <img src="images/image-6-770x416.jpg" alt="" style="width:100%;margin:50px 0px;">
                        <a>Nationwide</a>
